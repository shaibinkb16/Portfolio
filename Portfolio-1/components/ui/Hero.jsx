      ...
      <div className="container mx-auto">
        <div className="flex flex-col xl:flex-row justify-between gap-x-8 gap-y-8">
          ...
          <div className="flex w-full flex-col justify-center mx-auto xl:mx-0 text-center xl:text-left">
            ...
            >
              AI Engineer specializing in LLMs, Generative AI, and Voice AI with 1 year production experience. Building multi-agent platforms, RAG systems, and real-time voice AI solutions.
            </motion.p>
